...
<div class="row">
    <center>
        ...
        <header>
            ...
            <h4>Reporte de alquileres entre el {{ $inicio }} y {{ $fin }} <br> Cliente: {{ $cliente }}</h4>
        </header>
    </center>
</div>
<div class="row">
    @foreach($outputs as $output)
        <table class="margin">
            ...
            <tr>
                ...
                <th align="center" style="color: #fff; background: #4919c9;">FECHA ALQUILER</th>
                <th align="center" style="color: #fff; background: #4919c9;">TIPO</th>
                <th align="center" style="color: #fff; background: #4919c9;">TOTAL ALQUILER</th>
            ...
            <tr>
                ...
                <td align="center">{{ $output->fechaAlquiler }}</td>
