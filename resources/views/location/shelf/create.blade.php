        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    @endif
                    <form id="form" class="form-horizontal form-label-left" method="post" action="{{ url('anaquel/registrar/'.$local) }}">
                        ...
                        <div class="form-group text-center">
                            <a href="{{url('/anaquel/'.$local)}}" class="btn btn-danger">Cancelar</a>
